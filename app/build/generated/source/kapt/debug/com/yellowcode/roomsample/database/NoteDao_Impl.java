...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `note_table`(`id`,`name`,`email`,`contact`,`address`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpName,_tmpEmail,_tmpContact,_tmpAddress);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object findNoteByTitle(final String title, final Continuation<? super Note> p1) {
    final String _sql = "SELECT * FROM note_table WHERE name LIKE ?";
    ...
    return CoroutinesRoom.execute(__db, false, new Callable<Note>() {
      @Override
      public Note call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final String _tmpAddress;
            _tmpAddress = _cursor.getString(_cursorIndexOfAddress);
            _result = new Note(_tmpId,_tmpName,_tmpEmail,_tmpContact,_tmpAddress);
          } else {
            _result = null;
          }
          return _result;
